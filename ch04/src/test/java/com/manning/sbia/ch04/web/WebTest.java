...
//        Assert.assertTrue("Job should have been launched to reach the count down", countDownLatch.await(10, TimeUnit.SECONDS));
//
//        Assert.assertTrue(jobParams.isEmpty());
//        WebConversation wc = new WebConversation();
//        WebRequest req = new GetMethodWebRequest(BASE_URL + "?job=importProductsJob&date=20101215");
//        wc.getResponse(req);
//        Assert.assertFalse(jobParams.isEmpty());
//        Assert.assertEquals("20101215", jobParams.get("date"));
//
//        req = new GetMethodWebRequest(BASE_URL + "?job=importProductsJob");
//        wc.getResponse(req);
//        Assert.assertTrue(jobParams.isEmpty());
//    }
//
...
//
//        server.start();
//        countDownLatch = getWebAppSpringContext(wac).getBean(CountDownLatch.class);
...
//        ContextHandler.SContext servletContext = wac.getServletContext();
//
//        ApplicationContext webAppAppCtx = WebApplicationContextUtils.getWebApplicationContext(servletContext.getContext("/"));
//        return webAppAppCtx;
//    }
