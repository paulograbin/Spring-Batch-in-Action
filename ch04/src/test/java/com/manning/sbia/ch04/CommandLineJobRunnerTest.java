...
public class CommandLineJobRunnerTest {
    ...
    public void run() throws Exception {
        final Queue<Integer> exitCode = new ArrayBlockingQueue<>(1);
        ...
        CommandLineJobRunner.main(new String[]{"/com/manning/sbia/ch04/import-products-job-exit-code.xml", "importProductsJob"});
        Assert.assertEquals(Integer.valueOf(0), exitCode.poll());

        CommandLineJobRunner.main(new String[]{
                        "/com/manning/sbia/ch04/import-products-job-exit-code.xml", "importProductsJob",
